...
(window as any).electronAPI = {
  ...
  browserOpenDevTools: (agentId?: string, tabId?: string) => ipcRenderer.invoke('browser-open-devtools', { agentId, tabId }),
  browserDockView: (agentId?: string, bounds?: any) => ipcRenderer.invoke('browser-dock-view', { agentId, bounds }),
  browserUndockView: (agentId?: string) => ipcRenderer.invoke('browser-undock-view', { agentId }),
